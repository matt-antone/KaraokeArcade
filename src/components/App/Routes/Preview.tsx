...
const result = () => triviaFixtures.triviaResult({
  ...
  scores: [
    ...
    { userId: 2, name: 'Barf', score: 2, numAnswered: 3, avatarId: 'p2' },
...
const finalResult = () => triviaFixtures.triviaResult({
  ...
  numCorrect: 3,
  scores: [
    { userId: 1, name: 'Dot Matrix', score: 5, numAnswered: 5, avatarId: 'p1' },
    { userId: 2, name: 'Barf', score: 4, numAnswered: 5, avatarId: 'p2' },
    { userId: 3, name: 'Vespa', score: 3, numAnswered: 5, avatarId: 'p3' },
    { userId: 4, name: 'Lone Starr', score: 2, numAnswered: 4, avatarId: 'p4' },
    { userId: 5, name: 'Princess Vespa', score: 1, numAnswered: 3, avatarId: 'p5' },
  ],
